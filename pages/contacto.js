      ...
      <Section classes="xl:px-32 pt-16">
        <div className="p-6 mr-2 sm:rounded-lg flex flex-col items-center">
          ...
          <p className="text-lg sm:text-2xl font-medium text-gray-600 mt-2">
            ...
            mayorista o minorista, almacén, feria o de manera personal,
            escríbanos a cualquiera de nuestros medios de comunicación
            habilitados, indicando la finalidad de compra, su localidad y
            provincia. No dude en escribirnos, estamos para servirles.
          </p>
